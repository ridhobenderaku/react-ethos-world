...
const ProduktivitasInternal = ({ dataChart, setUpdate }) => {
  const data = {
    datasets: [
      {
        label: "RASIO ALL Manpower",
        data: dataChart ? dataChart.rasioall : null,
      ...
      {
        label: "RASIO CS",
        data: dataChart ? dataChart.rasiocs : null,
      ...
      {
        label: "RASIO ADV",
        data: dataChart ? dataChart.rasioadv : null,
...
export default ProduktivitasInternal;
