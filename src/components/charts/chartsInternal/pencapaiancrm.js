...
const PencapaianCrm = ({ dataChart, setUpdate }) => {
  const data = {
    datasets: [
      {
        label: "Daily Average Omset",
        data: dataChart ? dataChart.crmaverage : null,
      ...
      {
        label: "Target Omset",
        data: dataChart ? dataChart.crmtarget : null,
      ...
      {
        label: "Omset",
        data: dataChart ? dataChart.crmomset : null,
        ...
        <div className='container form-group text-right'>
          <div className='row'>
            <div className='col-md-7'>
              <h3 className='card-title'>Pencapaian CRM Internal By Omset</h3>
            </div>
