...
import CreateProjectModal from "../../components/project/createProject/createProjectModal";
import SearchProject from "../../components/project/searchProject";

export function HeaderTableProject({
  headerMenu,
  setActiveTab,
  handleRefresh,
  handleSearch,
        ...
        <div className='row  align-items-center mr-0  mr-sm-2 '>
          ...
          <div className='col-10  '>
            <ActionButton
              ...
              icon='fas fa-plus'
              dataToggle='modal'
              dataTarget='#modal-create-project'
            />
            <CreateProjectModal handleRefresh={handleRefresh} />
          </div>
        </div>
